...
public class Nominee1Fragment extends Fragment {

    private View bottomNav;

    public Nominee1Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_nominee1, container, false); // Make sure the layout file is named `fragment_nominee1.xml`
    }
