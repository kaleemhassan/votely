...
public class Nominee2Fragment extends Fragment {

    private View bottomNav;

    public Nominee2Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_nominee2, container, false); // Make sure the layout file is named `fragment_nominee2.xml`
    }
